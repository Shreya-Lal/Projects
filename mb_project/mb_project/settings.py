...
SECRET_KEY = 'p-0nrk-@jib380s2c(7b7!k@4(qtsr_tauta^ul!0b)fkn%+47'
...
if os.getcwd() == '/app':
    ...
    BASE_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__))) #this
